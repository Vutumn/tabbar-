...
@interface DelegateViewController () <myDelegate>
...
- (void)buttonAction:(UIButton *)sender {
    DelegateDetailViewController *vc = [[DelegateDetailViewController alloc]init];
...
- (void)setForwardTitle:(NSString *)myTitle {
    [self.button setTitle:myTitle forState:UIControlStateNormal];
}
